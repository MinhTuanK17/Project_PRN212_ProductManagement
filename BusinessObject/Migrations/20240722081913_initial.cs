    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "int", maxLength: 7, nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "P1001", 1, "256 GB", "The Iphone 14 Pro Max is the latest flagship model from Apple, featuring advanced camera systems, a stunning Super Retina XDR display, and the powerful A16 Bionic chip.", 34575m, 25, "Iphone 14 Pro Max", "16 GB" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, new DateTime(2024, 7, 22, 15, 19, 13, 575, DateTimeKind.Local).AddTicks(9515), "Confirmed" },
                    { 2, 10, new DateTime(2024, 7, 22, 15, 19, 13, 575, DateTimeKind.Local).AddTicks(9534), "Pending" },
                    { 3, 4, new DateTime(2024, 7, 22, 15, 19, 13, 575, DateTimeKind.Local).AddTicks(9535), "Cancelled" },
                    { 4, 9, new DateTime(2024, 7, 22, 15, 19, 13, 575, DateTimeKind.Local).AddTicks(9536), "Confirmed" },
                    { 5, 8, new DateTime(2024, 7, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Pending" },
                    { 6, 4, new DateTime(2024, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Confirmed" }
                });
